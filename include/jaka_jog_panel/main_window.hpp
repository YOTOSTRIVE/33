...
namespace Jaka_jog_panel
{
  class MainWindow : public QMainWindow
  {
    ...
    private Q_SLOTS:
      ...
      void on_line_moveButton_clicked();
      ...
      // void processFileInThread(const std::string& fileName);
      // void openFileInThread();
      void process_line(QByteArray line,int& sum,int& count);


      CartesianPose extractDoublesFromByteArray(const QByteArray &byteArray);
